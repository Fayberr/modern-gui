...
import net.fayber.moderngui.dev.WidgetTestScreen;
import net.minecraft.client.Minecraft;

/**
 * {@code /moderngui showcase}: opens the full widget catalog screen in-game, no startup flag
 * needed. This is the same screen the {@code -Dmoderngui.preview=true} dev hook auto-opens on
...
public final class ShowcaseCommand {
    ...
    private static void register(CommandDispatcher<FabricClientCommandSource> dispatcher) {
        dispatcher.register(ClientCommands.literal("moderngui")
