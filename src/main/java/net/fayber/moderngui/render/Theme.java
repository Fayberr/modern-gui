...
/**
 * The Modern GUI palette. Every widget and screen reads its colours through a Theme instance, so a
 ...
 * Modern Config palette. The surface greys have equal R/G/B so nothing reads as tinted, and there
