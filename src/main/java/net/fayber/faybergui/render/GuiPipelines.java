...
/**
 * The custom GUI render pipeline behind every rounded shape in Fayber GUI.
 *
...
public final class GuiPipelines {
    ...
    public static final Identifier WHITE = Identifier.fromNamespaceAndPath(FayberGuiClient.MOD_ID, "textures/gui/white.png");
    ...
    private static RenderPipeline buildRoundCorner() {
        ...
        RenderPipeline.Builder builder = RenderPipeline.builder()
                .withLocation(Identifier.fromNamespaceAndPath(FayberGuiClient.MOD_ID, "pipeline/round_corner"))
                .withVertexShader(base.getVertexShader())
                .withFragmentShader(Identifier.fromNamespaceAndPath(FayberGuiClient.MOD_ID, "core/round_corner"))
