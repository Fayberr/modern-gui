...
public class Modal {
    ...
    public void extract(GuiGraphicsExtractor gfx, Theme theme, int mouseX, int mouseY, float partialTick) {
        ...
        net.fayber.faybergui.render.Ui.rect(gfx, 0, 0, mc.getWindow().getGuiScaledWidth(),
                mc.getWindow().getGuiScaledHeight(), 0x88000000);

        net.fayber.faybergui.render.Ui.shadow(gfx, this.x, this.y, this.width, this.height, RADIUS, 8.0f, 5);
        net.fayber.faybergui.render.Ui.roundRect(gfx, this.x, this.y, this.width, this.height, RADIUS, theme.card);
