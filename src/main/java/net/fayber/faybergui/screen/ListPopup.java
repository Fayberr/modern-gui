 ...
 * {@link net.fayber.faybergui.widget.Dropdown}, or directly for custom menus.
 *
...
public class ListPopup {
    ...
    public void extract(GuiGraphicsExtractor gfx, Theme theme, int mouseX, int mouseY, float partialTick) {
        this.position(theme);
        net.fayber.faybergui.render.Ui.shadow(gfx, this.x, this.y, this.width, this.height, RADIUS, 6.0f, 4);
        net.fayber.faybergui.render.Ui.roundRectBorder(gfx, this.x, this.y, this.width, this.height, RADIUS,
        ...
        for (int i = 0; i < visible; i++) {
            ...
            if (hovered) {
                net.fayber.faybergui.render.Ui.roundRect(gfx, rowX, rowY, rowW, ROW_HEIGHT, 4.0f, theme.cardHover);
            }
