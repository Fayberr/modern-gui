...
import net.fayber.faybergui.screen.FayberGuiScreen;
import net.fayber.faybergui.screen.Modal;
import net.fayber.faybergui.screen.Toast;
import net.fayber.faybergui.widget.Badge;
import net.fayber.faybergui.widget.Checkbox;
import net.fayber.faybergui.widget.CollapsibleSection;
import net.fayber.faybergui.widget.CycleButton;
import net.fayber.faybergui.widget.Divider;
...
import net.fayber.faybergui.widget.HFlow;
import net.fayber.faybergui.widget.IconButton;
import net.fayber.faybergui.widget.Icons;
import net.fayber.faybergui.widget.IntSlider;
import net.fayber.faybergui.widget.KeybindField;
import net.fayber.faybergui.widget.Label;
import net.fayber.faybergui.widget.Layouts;
import net.fayber.faybergui.widget.NumberField;
import net.fayber.faybergui.widget.PillToggle;
import net.fayber.faybergui.widget.ProgressBar;
import net.fayber.faybergui.widget.RadioGroup;
import net.fayber.faybergui.widget.SearchField;
import net.fayber.faybergui.widget.SegmentedControl;
import net.fayber.faybergui.widget.Spinner;
import net.fayber.faybergui.widget.Stepper;
 ...
 * {@code -Dfaybergui.preview=true} workbench hook, and all of its backing state lives here as
 ...
 */
public final class WidgetTestScreen extends FayberGuiScreen {
    ...
    public WidgetTestScreen() {
        super(Component.literal("Fayber GUI Widget Test"));
    }
